...
var _PokerHandForm = __webpack_require__(/*! ./PokerHandForm */ "./src/components/PokerHandForm.js");

var _PokerHandForm2 = _interopRequireDefault(_PokerHandForm);
...
/***/ "./src/components/PokerHandForm.js":
/*!*****************************************!*\
  !*** ./src/components/PokerHandForm.js ***!
  \*****************************************/
/*! no static exports found */
...
var PokerHandForm = function (_React$Component) {
  ...
  function PokerHandForm() {
    _classCallCheck(this, PokerHandForm);

    var _this = _possibleConstructorReturn(this, (PokerHandForm.__proto__ || Object.getPrototypeOf(PokerHandForm)).call(this));
  ...
  _createClass(PokerHandForm, [{
    key: "handlePlayerChange",
    value: function handlePlayerChange(event) {
      this.setState({
    ...
    value: function handleOpponentChange(event) {
      this.setState({
